...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1403: () => Date.now(),
      _1404: () => new AbortController(),
      _1405: x0 => x0.abort(),
      _1406: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1407: (x0,x1) => globalThis.fetch(x0,x1),
      _1408: (x0,x1) => x0.get(x1),
      _1409: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1409(f,arguments.length,x0,x1,x2) }),
      _1410: (x0,x1) => x0.forEach(x1),
      _1411: x0 => x0.getReader(),
      _1412: x0 => x0.read(),
      _1413: x0 => x0.cancel(),
      _1440: (s, m) => {
        try {
      ...
      _1441: (x0,x1) => x0.exec(x1),
      _1442: (x0,x1) => x0.test(x1),
      _1443: x0 => x0.pop(),
      _1445: o => o === undefined,
      _1447: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1449: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1450: o => o instanceof RegExp,
      _1451: (l, r) => l === r,
      _1452: o => o,
      _1453: o => o,
      _1454: o => o,
      ...
      _1456: o => o.length,
      _1458: (o, i) => o[i],
      _1459: f => f.dartFunction,
      _1460: () => ({}),
      _1461: () => [],
      _1463: () => globalThis,
      _1464: (constructor, args) => {
      ...
      _1466: (o, p) => o[p],
      _1467: (o, p, v) => o[p] = v,
      _1468: (o, m, a) => o[m].apply(o, a),
      _1470: o => String(o),
      _1471: (p, s, f) => p.then(s, f),
      _1472: o => {
      ...
      _1499: (o, p) => o[p],
      _1502: x0 => x0.random(),
      _1505: () => globalThis.Math,
      _1506: Function.prototype.call.bind(Number.prototype.toString),
      _1507: Function.prototype.call.bind(BigInt.prototype.toString),
      _1508: Function.prototype.call.bind(Number.prototype.toString),
      _1509: (d, digits) => d.toFixed(digits),
      _3388: () => globalThis.window,
      _3450: x0 => x0.navigator,
      _3839: x0 => x0.userAgent,
      _5994: x0 => x0.signal,
      _7830: x0 => x0.value,
      _7832: x0 => x0.done,
      _8534: x0 => x0.url,
      _8536: x0 => x0.status,
      _8538: x0 => x0.statusText,
      _8539: x0 => x0.headers,
      _8540: x0 => x0.body,
      _12168: x0 => x0.name,
...
"SmartDashesType.",
"EditableText-",
"AI not configured. The API key is missing.",
"Sorry, I couldn't process that. Try again.",
"Gemini API Error: ",
"Sorry, I couldn't connect to the AI. The API key might be invalid or there's a network issue.",
...
"Designed by Tharanitharan Kumarasamy",
"Chat With Me",
"FlexFit.",
"Have a question? Or just want to say hello?",
"My AI assistant is here to help. Click below to start a conversation.",
"Ask me about my projects...",
"What are your skills?",
"Tell me about your education...",
"_currentText",
"AIzaSyDeij_zN23ZhmWGD0M-Tab-rfRanNrulXM",
"GQ==",
"Gg==",
"Gw==",
"HA==",
...
"Sink is closed",
"  You are Tharanitharan K, a passionate Flutter developer from Karur, Tamil Nadu. \n  Your personality is direct, confident, and focused on building great apps. \n  You are chatting with a visitor on your portfolio. \n  Answer their questions based ONLY on the following information about you. \n  By default, keep your answers concise, professional, and conversational, just as Tharanitharan would speak. \n  Do not use emojis unless the user asks for a casual/funny tone.  \n\n  **Tone Rules:**\n  - Default: Professional, confident, concise.  \n  - If user says they prefer casual/funny/friendly tone → switch to being warm, kind, and a little charming with emojis 😄✨  \n  - Match the user’s style: if they are formal, stay formal; if they are casual, mirror that.  \n\n  **My Information:**\n  - **Name:** Tharanitharan K\n  - **Location:** Karur, Tamil Nadu, India\n  - **Email:** tharanitharan305@gmail.com\n  - **GitHub:** https://github.com/tharanitharan305\n  - **LinkedIn:** https://www.linkedin.com/in/tharanitharan-kumarasamy-/\n  - **LeetCode:** https://leetcode.com/u/tharanitharan3/\n\n  **Education:** \n  - B.E. Computer Science Engineering (2021–2025), Karpagam College of Engineering, CGPA: 7.55\n\n  **Objective:** \n  Seeking a challenging position to learn, grow, and contribute my skills in real-world applications.\n\n  **Core Skills:** Flutter, Dart, Firebase, REST API, PHP, MySQL, Java, C, Bloc, Provider, Git, Docker, Postman, UI/UX, AWS basics, LLMs\n\n  **Key Projects:**  \n  - BeeZet (IT company site & admin panel, Flutter + PHP + MySQL)  \n  - Brisa Munda Trust (NGO site with member/volunteer management)  \n  - TAT (Grocery billing app for family business, Flutter + Firebase + Bloc)  \n  - Face Recognition Attendance System (local + AWS, face verification)  \n  - Fine-tuned LLM (Phi3 + Unsloth, hosted on VPS)  \n  - PDF → Excel Parser (Python backend + Flutter frontend)  \n  - Flutter Camera + AI (real-time face recognition with animated borders)  \n  - Gemini + Flutter Chatbot (this assistant)  \n\n  **Certificates:**  \n  - NPTEL: C Programming (Elite + Silver)  \n  - NPTEL: DSA with Java (Elite)  \n  - Udemy: Flutter Development Bootcamp  \n\n  **Strengths:** Quick learner, experimental, strong problem-solving, independent worker, full-stack mindset.  \n  **Interests:** Mobile apps, AI/LLMs, DevOps, open-source, competitive coding.  \n\n  **Instruction:**  \n  Start the conversation by saying:  \n  \"Hey there! I'm Tharanitharan's AI assistant. Feel free to ask anything about my skills, projects, or experiences.\"\n  ",
"_model",
"gemini-1.5-flash",
"models",
"prefix",
...
"MySQL",
"REST API",
"A complete dynamic website and admin panel for an IT company. The admin panel allows for dynamic content management for projects, about section, contact, and careers.",
"BeeZet - Company Website & Admin Panel",
"https://github.com/tharanitharan305/Beezet",
"Developed a dynamic website with an admin panel for an NGO, featuring membership and volunteer management, a dynamic gallery, and team member updates.",
"Brisa Munda Trust - NGO Website",
"https://github.com/tharanitharan305/brisa_munda_trust",
"Firebase",
"Bloc",
"A mobile application for a family grocery shop to generate bills faster and track weekly sales. Includes a companion HTML site for details and app updates.",
"TAT - Grocery Billing App",
"https://github.com/tharanitharan305/tat",
"FontAwesomeBrands",
"View on GitHub",
"spaceBetween",
"fade",
...
"C",
"UI/UX Design",
"Ever since my college days, I've been captivated by the power of code to bring ideas to life. This curiosity for building beautiful and functional apps and websites is what drives me. I love diving into new challenges, learning continuously, and transforming complex problems into elegant solutions. This portfolio is a showcase of that passion and dedication.",
"LeetCode Problems",
...
"_leetCodeCount",
"Hi, I'm",
"I build stunning apps with Flutter.",
"I'm a passionate Computer Science Engineering student with a strong focus on creating beautiful, high-performance mobile and web applications using Flutter.",
"FontAwesomeRegular",
"Tharanitharan K.",
"mailto:tharanitharan305@gmail.com",
"https://leetcode.com/u/tharanitharan3/",
"https://www.linkedin.com/in/tharanitharan-kumarasamy-/",
"https://github.com/tharanitharan305",
"_stars",
...
"maxValue",
"Hello",
"https://api.github.com/users/tharanitharan305",
"Hw==",
"public_repos",
"GET",
